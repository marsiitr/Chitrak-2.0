...
[theta2(1), theta2(2)] = inverse_kinematics_stance(x(i), z, l1, l2); %stance leg
%[theta(3) theta(4)] = inverse_kinematics(xe5, ye5, a1, a2);

%3 Stance Leg
P2 = [0, 0.75+o2(2)+x(i) ,0.40];
...
P3 = [0.45,o3(2)+x(i),0.40];
P31 =  P3 + [0, l1*cos(theta2(1)) , -l1*sin(theta2(1))];
P32 = P3 +[0, (0.2/3)+l1*cos(theta2(1)) + l2*cos(theta2(1)+theta2(2)) , -l1*sin(theta2(1)) - l2*sin(theta2(1) + theta2(2))];

P4 = [0.45,0.75+o4(2)+x(i),0.40];
P41 =  P4 + [0, l1*cos(theta2(1)) , -l1*sin(theta2(1))];
P42 = P4 +[0, 0.2+l1*cos(theta2(1)) + l2*cos(theta2(1)+theta2(2)) , -l1*sin(theta2(1)) - l2*sin(theta2(1) + theta2(2))];
...
% plot3(P12(1,1),P12(1,2),P12(1,3))
 ...
 %Link for Stance Leg
 line2 = line([P1(1) P11(1)],[P1(2) P11(2)],[P1(3) P11(3)] , 'LineWidth',3 ,'Color','red');
 line3 = line([P11(1) P12(1)],[P11(2) P12(2)],[P11(3) P12(3)], 'LineWidth',2,'Color','red');
 ...
 delete(line13);
  ...
  if(x(i)>stride_length/2)
    o1 = o1+ [0 stride_length 0];
    o2 = o2+ [0 stride_length 0];
    o3 = o3+ [0 stride_length 0];
    o4 = o4+ [0 stride_length 0];
    flag = 2;
    i=1;
    break;
...
[theta3(1), theta3(2)] = inverse_kinematics_stance(x(i), z, l1, l2); %stance leg
%[theta(3) theta(4)] = inverse_kinematics(xe5, ye5, a1, a2);

%3 Stance Leg
P1 = [0, 0+o1(2)+x(i), 0.40];
P11 =  P1 + [0, l1*cos(theta3(1)) , -l1*sin(theta3(1))];
P12 = P1 +[0, 0.2+l1*cos(theta3(1)) + l2*cos(theta3(1)+theta3(2)) , -l1*sin(theta3(1)) - l2*sin(theta3(1) + theta3(2))];
...
P4 = [0.45,0.75+o4(2)+x(i),0.40];
P41 =  P4 + [0, l1*cos(theta3(1)) , -l1*sin(theta3(1))];
P42 = P4 +[0, (0.2/3)+l1*cos(theta3(1)) + l2*cos(theta3(1)+theta3(2)) , -l1*sin(theta3(1)) - l2*sin(theta3(1) + theta3(2))];
...
%  Traj_identi = viscircles(P12,0.001);
 ...
 %Link for swing Leg
 line4 = line([P2(1) P21(1)],[P2(2) P21(2)] ,[P2(3) P21(3)] , 'LineWidth',3 ,'Color','red');
 line5 = line([P21(1) P22(1)],[P21(2) P22(2)],[P21(3) P22(3)], 'LineWidth',2,'Color','red');
...
P1 = [0, 0+o1(2)+x(i), 0.40];
P11 =  P1 + [0, l1*cos(theta2(1)) , -l1*sin(theta2(1))];
P12 = P1 +[0, (-0.2/3)+l1*cos(theta2(1)) + l2*cos(theta2(1)+theta2(2)) , -l1*sin(theta2(1)) - l2*sin(theta2(1) + theta2(2))];
...
%  Traj_identi = viscircles(P12,0.001);
 ...
 line6 = line([P3(1) P31(1)],[P3(2) P31(2)] ,[P3(3) P31(3)] , 'LineWidth',3 ,'Color','red');
 line7 = line([P31(1) P32(1)],[P31(2) P32(2)],[P31(3) P32(3)], 'LineWidth',2,'Color','red');
...
[theta1(1), theta1(2)] = inverse_kinematics_stance(x(i), z, l1, l2); %stance leg
%[theta(3) theta(4)] = inverse_kinematics(xe5, ye5, a1, a2);

%3 Stance Leg
P2 = [0, 0.75+o2(2)+x(i) ,0.40];
P21 =  P2 + [0, l1*cos(theta1(1)) , -l1*sin(theta1(1))];
P22 = P2 +[0, (0.2/3)+l1*cos(theta1(1)) + l2*cos(theta1(1)+theta1(2)) , -l1*sin(theta1(1)) - l2*sin(theta1(1) + theta1(2))];

P3 = [0.45,o3(2)+x(i),0.40];
P31 =  P3 + [0, l1*cos(theta1(1)) , -l1*sin(theta1(1))];
P32 = P3 +[0, 0.2+l1*cos(theta1(1)) + l2*cos(theta1(1)+theta1(2)) , -l1*sin(theta1(1)) - l2*sin(theta1(1) + theta1(2))];
...
%  Traj_identi = viscircles(P12,0.001);
 ...
 line8 = line([P4(1) P41(1)],[P4(2) P41(2)] ,[P4(3) P41(3)] , 'LineWidth',3 ,'Color','red');
 line9 = line([P41(1) P42(1)],[P41(2) P42(2)],[P41(3) P42(3)], 'LineWidth',2,'Color','red');
