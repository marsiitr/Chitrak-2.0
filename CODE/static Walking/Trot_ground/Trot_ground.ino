...
double theta2AT1_1 = 55.19, theta2AT2_1 = 65.07, theta2AT3_1 = 59.15, theta2_AT1_1 = 0, theta2_AT2_1 = 0.1, theta2_AT3_1 = 0, theta2__AT1_1 = 0, theta2__AT2_1 = 0.1, theta2__AT3_1 = 0;
...
double theta2AT1_2 = 56.58, theta2AT2_2 = 66.29, theta2AT3_2 = 57.85, theta2_AT1_2 = 0, theta2_AT2_2 = 0.1, theta2_AT3_2 = 0, theta2__AT1_2 = 0, theta2__AT2_2 = 0.1, theta2__AT3_2 = 0;
...
double theta2AT1_3 = 55.19, theta2AT2_3 = 65.07, theta2AT3_3 = 59.15, theta2_AT1_3 = 0, theta2_AT2_3 = 0.1, theta2_AT3_3 = 0, theta2__AT1_3 = 0, theta2__AT2_3 = 0.1, theta2__AT3_3 = 0;
...
double theta2AT1_4 = 56.58, theta2AT2_4 = 66.65, theta2AT3_4 = 57.85, theta2_AT1_4 = 0, theta2_AT2_4 = 0.1, theta2_AT3_4 = 0, theta2__AT1_4 = 0, theta2__AT2_4 = 0.1, theta2__AT3_4 = 0;
...
//3
    ...
    ll1=0.0, lm1=70.0, ul1=56.0, um1 = 65.0;
    ...
    ll1=0.0, lm1=70.0, ul1=42.0, um1=49.0;
...
//    theta2_2 = 57.2958 * (-3.14159 + cosine_rule(sqrt(xe_2 * xe_2 + ye_2 * ye_2), l1, l2));
    ...
    ll1=0.0, lm1=40.0, ul1=58.5, um1=69.0;
...
//    theta2_3 = 57.2958 * (-3.14159 + cosine_rule(sqrt(xe_3 * xe_3 + ye_3 * ye_3), l1, l2));
    ...
    ll1=0.0, lm1=40.0, ul1=58, um1=69.0;    
    ll2=0.0, lm2=90.0, ul2=20.0, um2=45.0;
    ...
    ll1=0.0, lm1=70.0, ul1=43.0, um1=51.0;
...
//    correction1_4 = (um1-ul1)/(lm1-ll1)*abs(c1_4)+ul1;
    ...
    ll1=0.0, lm1=70.0, ul1=37, um1=46.0;
...
//    theta2_1 = 57.2958 * (-3.14159 + cosine_rule(sqrt(xe_1 * xe_1 + ye_1 * ye_1), l1, l2));
    ...
    ll1=0.0, lm1=40.0, ul1=52, um1=64.0;    
    ll2=0.0, lm2=90.0, ul2=32.0, um2=44.0;
    ...
    ll1=0.0, lm1=70.0, ul1=49.0, um1 = 59.0;
//    correction1_2 = (um1-ul1)/(lm1-ll1)*abs(c1_2)+ul1;
    
    if(t<0.5)
    correction1_2 = (um1-ul1)/(lm1-ll1)*abs(c1_2)+ul1;
    else{
    ll1=0.0, lm1=70.0, ul1=41.0, um1= 47.0;
...
//    if(t==0.4 || t==0.5 || t==0.6) correction1_2 = 45;
    ...
    ll1=0.0, lm1=70.0, ul1=46.0, um1=58.0;
    ...
    ll1=0.0, lm1=70.0, ul1=38.0, um1=45.0;
    correction1_3 = (um1-ul1)/(lm1-ll1)*abs(c1_3)+ul1;      //TODO   0-60
    }

    
    if(t<0.5){
    ll2=0.0, lm2=70.0, ul2=140.0, um2=180.0;
    correction2_3 = (um2-ul2)/(lm2-ll2)*abs(c2_3) + ul2;      //TODO
    }
    else{
      ll2=0.0, lm2=70.0, ul2=70.0, um2=120.0;
    correction2_3 = (um2-ul2)/(lm2-ll2)*abs(c2_3) + ul2;
    }
...
//    theta2_4 = 57.2958 * (-3.14159 + cosine_rule(sqrt(xe_4 * xe_4 + ye_4 * ye_4), l1, l2));
    ...
    ll1=0.0, lm1=30.0, ul1=48, um1=60;
